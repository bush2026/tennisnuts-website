(function () {
  ...
  style.textContent = [
    ...
    '.site-footer .footer-grid{max-width:1240px;margin:0 auto;padding:0 28px;display:grid;grid-template-columns:1.4fr 1fr 1fr 1fr;gap:48px;margin-bottom:56px;}',
    ...
    '.site-footer .footer-newsletter button{background:#cddc39;color:#2c4621;font-weight:600;font-size:13px;padding:10px 16px;border:0;cursor:pointer;flex-shrink:0;}',
  ...
  var footerHTML = '<footer class="site-footer">'
    ...
    + '<li><a href="sopal-trophy.html">Sopal Trophy</a></li>'
    ...
    + '<li><a href="tennis-bytes.html">Tennis Bytes</a></li>'
