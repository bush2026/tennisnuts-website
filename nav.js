(function () {
  ...
  var navHTML = '<nav class="site-nav" id="main-nav">'
    ...
    + '<a href="sopal-trophy.html">Sopal Trophy</a>'
    + '<a href="corporate-tournament.html">Corporate Tournament</a>'
    + '</div>'
    + '</li>'
    + '<li>'
    + '<button aria-haspopup="true">Community <svg class="chevron" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5"><path d="M6 9l6 6 6-6"/></svg></button>'
    + '<div class="dropdown-menu">'
