        ...
        <div className="hero-content">
          ...
          <div>
            <div className="hero-eyebrow">
              ...
              Pune's friendliest tennis community · 800+ members
            </div>
            <h1>
            ...
            <div className="hero-stats" role="list" aria-label="Community stats">
              ...
              <div className="stat" role="listitem">
                ...
                <div className="label">Events / Year</div>
              </div>
              <div className="stat" role="listitem">
                <div className="num">12</div>
                <div className="label">Partner Courts</div>
              </div>
            </div>
          </div>

          {/* Right column — photo collage placeholders */}
          <div className="hero-collage" aria-hidden="true">
            <div className="hero-card hero-card-1">
              <div className="ph">/* action shot — forehand at sunset */</div>
            </div>
            <div className="hero-card hero-card-2">
              <div className="ph">/* group huddle, post match */</div>
            </div>
            <div className="hero-card hero-card-3">
              <div className="ph">/* trophy presentation */</div>
            </div>
        ...
        <div className="who-grid">
          <div className="who-copy">
            ...
            <div className="who-tags">
              <span className="who-tag"><span className="b" aria-hidden="true"></span> Open to all levels</span>
              <span className="who-tag"><span className="b" aria-hidden="true"></span> Singles · Doubles · Mixed</span>
              <span className="who-tag"><span className="b" aria-hidden="true"></span> Pune-wide</span>
              <span className="who-tag"><span className="b" aria-hidden="true"></span> Est. 2021</span>
            </div>
          </div>
          ...
          <div style={{ position: "relative" }}>
            ...
            <div className="who-badge" aria-hidden="true">
    ...
    <section className="section activities" id="activities">
      <div className="container">
        ...
        <div className="act-grid">
          {ACTIVITIES.map((a, i) => (
            <article key={a.t} className="act-card">
              <div className="head">
                <div className="icon" aria-hidden="true">{a.i}</div>
        ...
        <div className="section-head">
          ...
          <div className="right" style={{ display: "flex", alignItems: "end", justifyContent: "space-between", gap: 24 }}>
            ...
            <div className="events-nav">
              <button onClick={() => scroll(-1)} aria-label="Previous events">
                <Ic.Arrow style={{ transform: "rotate(180deg)" }}/>
              </button>
              <button onClick={() => scroll(1)} aria-label="Next events">
                <Ic.Arrow/>
              </button>
            </div>
          </div>
          ...
          {EVENTS.map((e, i) => (
            <article key={i} className="event-card">
              <div className={`event-banner ${e.banner}`}>
                ...
                <div className="date" aria-label={`${e.d} ${e.m}`}>
              ...
              <div className="event-body">
                ...
                <div className="event-meta">
                  <div><Ic.Pin className="ic" aria-hidden="true"/> {e.place}</div>
                  <div><Ic.Clock className="ic" aria-hidden="true"/> {e.time}</div>
                </div>
                <div className="event-foot">
                  <div className="spots">
                    <Ic.Users style={{ verticalAlign: "middle", marginRight: 6, color: "var(--green)" }} aria-hidden="true"/>
                    <b>{e.spots}</b> spots left
                  </div>
          ...
          {TESTIMONIALS.map((t, i) => (
            <div key={i} className="test-card">
              ...
              <div className="test-author">
                <div className="test-avatar" aria-hidden="true">{t.a}</div>
                <div className="who">
          ...
          <div className="logos">
            {LOGOS.map((l, i) => (
              <div key={l} className={`logo-chip b${i + 1}`}>
                <span className="lm" aria-hidden="true"></span>{l}
              </div>
            ))}
          </div>
        </div>
...
function Join() {
  return (
    <section className="join" id="join">
      <div className="container">
        <h2>Ready to find your <span className="accent">court crew?</span></h2>
        <p>
          Join 800+ players across Pune who show up every weekend, chase trophies,
          share meals, and call each other teammates.
        </p>
        <div className="join-ctas">
          <a href="https://tennisnuts.co.in" className="btn btn-ball">
            Join Us <Ic.Arrow/>
          </a>
          <a href="#events" className="btn btn-ghost">
            <Ic.Play/> See Upcoming Events
          </a>
        </div>
      </div>
    </section>
        ...
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <div className="footer-newsletter">
              <input type="email" placeholder="Your email — get the weekly fixtures" aria-label="Email for newsletter"/>
          ...
          <div className="footer-col">
            ...
            <div className="socials">
              ...
              <a href="#" aria-label="X / Twitter"><Ic.X/></a>
            </div>
          </div>
        </div>
